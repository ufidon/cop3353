...
Write a script implementing the logic of guessing numbers. Below is a list of requirements:

1. Show a splash of ASCII art followed by its usage once when users run this game.
...
```    
2. Design a game loop, so use can choose commands to do various things
